  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-6 py-24 sm:px-8 lg:px-12">
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <span className="text-xs font-semibold uppercase tracking-[0.1em] text-teal-400">
                Asset Intelligence Platform
              </span>
            </motion.div>

            {/* Headline */}
            <h1 className="mb-6 text-5xl font-extrabold leading-[1.05] tracking-tight text-white whitespace-nowrap sm:text-6xl md:text-7xl lg:text-[5.2rem]">
            ...
            >
              ...
              <MagneticButton>
                <Button
                  ...
                  size="lg"
                  asChild
                  className="rounded-full border-white/20 bg-white/5 px-8 py-6 text-base font-semibold text-white backdrop-blur-sm transition-all hover:border-white/40 hover:bg-white/10"
                >
        ...
        {/* ── Bottom Stats Strip ── */}
        <motion.div
          className="hero-stat-strip absolute bottom-0 left-0 right-0 border-t border-white/5"
        ...
        >
          ...
          <ChevronDown className="scroll-indicator size-4 text-slate-600" />
        </motion.div>
      </div>
    </section>
  );
